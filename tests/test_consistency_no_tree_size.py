...
def test_missing_root_hash_argument(mocker):
    ...
    mocker.patch("sys.argv", ['python3', 'main.py', '--consistency', '--tree-id', '1193050959916656506', '--tree-size', '--root-hash','57cad27753aa95e75cf661e1b0e9e95ead65a92eb2bab495011b4632a1b75d12'])
